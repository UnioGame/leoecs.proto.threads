...
namespace Leopotam.EcsProto.Threads {
    ...
    static class ThreadService {
        ...
        static Slice<MaskItem> _incMaskIndices;
        static Slice<MaskItem> _excMaskIndices;
        ...
        public static void Run (ProtoThreadHandler cb, ProtoWorld world, ProtoEntity[] entities, int count, Slice<MaskItem> incMaskIndices, Slice<MaskItem> excMaskIndices, int chunkSize, int workersLimit) {
#if DEBUG
            ...
            _mainThreadIt.Init (_world, _entities, _incMaskIndices, _excMaskIndices, processed, count);
        ...
        static void ThreadProc (object raw) {
            ...
            try {
                while (Thread.CurrentThread.IsAlive) {
                    ...
                    desc.HasWork.Reset ();
                    it.Init (_world, _entities, _incMaskIndices, _excMaskIndices, desc.FromIndex, desc.BeforeIndex);
                    _task.Invoke (it);
                    it.Clear ();
                    desc.WorkDone.Set ();
                }
